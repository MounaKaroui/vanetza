#ifndef NO_RATE_CONTROL_HPP_AM7LROYD
#define NO_RATE_CONTROL_HPP_AM7LROYD
 ...
 */
    class NoRateControl : public TransmitRateControl
    {
    public:
        NoRateControl(const StateMachine&, const Runtime& rt);
